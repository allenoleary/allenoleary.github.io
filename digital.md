...
<p class="logline">A flash interactive.</p>

<p>This uses a bit of basic flash programming to create a visual/soundscape based on keyboard input.</p>

<button type="button" class="collapsible" aria-label="Show details on the hypertext project called A Thread">Details [+]</button>
  <div class="content">
  <p>You will need to have a (rare) flash enabled browser and grant Flash plugin access to use this one.</p>
...
<div class="content">
    ...
    <p><img src="/assets/img/sin.jpg" width="100%"></p>
